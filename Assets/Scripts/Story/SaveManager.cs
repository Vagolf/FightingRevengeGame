    ...
    public static class SaveManager
    {
        ...
        public static List<SaveData> GetAll()
        {
            ...
            try
            {
                ...
                return wrap != null && wrap.items != null ? wrap.items : new List<SaveData>();
            }
            catch (Exception e)
            {
        ...
        private static void Persist(List<SaveData> list)
        {
            try
            {
                var wrap = new SaveDataList { items = list };
        ...
        public static SaveData Create(string displayName, Difficulty difficulty)
        {
            ...
            var data = new SaveData
            {
                ...
                name = string.IsNullOrWhiteSpace(displayName) ? $"Save {saves.Count + 1}" : displayName.Trim(),
